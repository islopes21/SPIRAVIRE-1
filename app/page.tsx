export default function Home() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-16">
      ...
      <h2 className="text-3xl font-bold mt-12 mb-6">Get to know us!</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="p-5 border rounded-lg bg-gray-50">
          ...
          <h4 className="font-semibold text-md mb-2 text-gray-700">Group of Organic Chemistry (PI: Prof. Teresa Pinho e Melo)</h4>
        ...
        <div className="p-5 border rounded-lg bg-gray-50">
          ...
          <h4 className="font-semibold text-md mb-2 text-gray-700">HEEP group (PI: Prof. Nuno Taveira)</h4>
        ...
        <div className="p-5 border rounded-lg bg-gray-50">
          ...
          <h4 className="font-semibold text-md mb-2 text-gray-700">Cell Biology of Viral Infection Laboratory (PI: Prof. Marta Alenquer)</h4>
